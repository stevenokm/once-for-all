...
ofa_supernet_mbv3_w10 = partial(
    ofa_net, net_id="ofa_mbv3_d234_e346_k357_w1.0", pretrained=True
)
ofa_supernet_mbv3_w12 = partial(
    ofa_net, net_id="ofa_mbv3_d234_e346_k357_w1.2", pretrained=True
)
ofa_supernet_proxyless = partial(
    ofa_net, net_id="ofa_proxyless_d234_e346_k357_w1.3", pretrained=True
)
...
resnet50D_MAC_1_2B = partial(
    ofa_specialized, net_id="resnet50D_MAC@1.2B_top1@77.1_finetune@25"
)
resnet50D_MAC_0_9B = partial(
    ofa_specialized, net_id="resnet50D_MAC@0.9B_top1@76.3_finetune@25"
)
resnet50D_MAC_0_6B = partial(
    ofa_specialized, net_id="resnet50D_MAC@0.6B_top1@75.0_finetune@25"
)
