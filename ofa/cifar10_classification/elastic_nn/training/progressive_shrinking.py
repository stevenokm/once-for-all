...
from ofa.cifar10_classification.run_manager import DistributedRunManager
...
def validate_max(
    ...
    loss, (top1, top5) = run_manager.validate(
        epoch=epoch, is_test=is_test, run_str="teachernet", net=dynamic_net
    )
