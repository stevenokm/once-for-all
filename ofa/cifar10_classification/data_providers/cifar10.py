...
class Cifar10DataProvider(DataProvider):
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser("~/cifar10_data")
    ...
    def train_dataset(self, _transforms):
        return datasets.CIFAR10(
            root=self.train_path, transform=_transforms, train=True, download=True
        )

    def test_dataset(self, _transforms):
        return datasets.CIFAR10(
            root=self.train_path, transform=_transforms, train=False, download=True
        )
